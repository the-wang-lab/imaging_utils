...
# %% [markdown]
# Workflow to feed ROIs drawn in ImageJ into suite2p. 
#
# Recreated after [this thread](https://github.com/MouseLand/suite2p/issues/292).
# Note that ROIs drawn with ImageJ are binary masks
# and may lead to unreliable extracted traces.
#
# # requirements
#
...
p_s2p = Path(r"C:\temp\s2p\test_recording\gui\suite2p\plane0")
p_ops = p_s2p / "ops.npy"
